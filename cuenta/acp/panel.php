...
$pdf->Ln(10);
$pdf->Write(90, strftime("%d de %B del %Y", time()));//strftime("%d de %B del %Y",strtotime($row["fecha_creado"])));
$pdf->Ln(10);
$pdf->Write(90,'Estimado/a '.utf8_decode($autor["Nombre"]." ".$autor["Apellidos"]." ".$autor["Apellidos2"]));
$pdf->Ln(5);
$pdf->Write(90,utf8_decode($ins["Institucion"]));
$pdf->Ln(5);
$pdf->Write(90,'Presente');
$pdf->Ln(60);
$pdf->Write(6,utf8_decode('Nos es grato informarle que el panel que usted integra, titulado: '));
$pdf->Ln(10);
$pdf->MultiCell(190,6,str_replace($rem,$to,utf8_decode(html_entity_decode($row["titulo_tl"]))),0,'C');
$pdf->Ln(10);
$pdf->Write(6,utf8_decode('ha sido aceptado para participar del XXXI Congreso de la Asociación Latinoamericana de Sociología, a realizarse entre el 3 y el 8 de diciembre de 2017 en la ciudad de Montevideo.'));
$pdf->Ln(10);
$pdf->Write(6, utf8_decode('Le recordamos que para participar en el panel debe estar inscripto y haber abonado la matrícula al momento de la presentación.'));
$pdf->Ln(20);

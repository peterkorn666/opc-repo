...
<div class="container">
	...
	<div class="row">
        <div class="col-md-6 col-md-offset-3 col-lg-offset-3  col-sm-offset-0 text-center">
            ...
            <br><small><a href="salir.php">salir</a></small></h3>
    ...
    <div class="row" align="center">
    	<div class="col-md-6 col-md-offset-3 col-lg-offset-3  col-sm-offset-0 text-left" style="text-align:justify;">
        	<strong align="center">El punto verde adelante del nombre significa que usted cumplió con el requisito de pagar y esta en condiciones de exponer su trabajo.</strong>
        </div>
    </div>
	...
	/*$trabajos_de_cuenta = $cuenta->getTrabajosByCuenta($inscripto["id_cuenta"]); // los de trabajos_libres
	$trabajos_inscripto = "";
	$contador = 0;
	if ($trabajos_de_cuenta) {
		foreach ($trabajos_de_cuenta as $tdc) {
			if ($trabajos_inscripcion["numeros_trabajos"] == "" || ($trabajos_inscripcion["numeros_trabajos"] != "" && substr_count($trabajos_inscripcion["numeros_trabajos"], $tdc["numero_tl"], 0)==0)){ // para no repetir el numero de trabajo 2 veces.
				$trabajos_inscripto .= $tdc["numero_tl"] . ", ";
				$contador = $contador + 1;
			}
		}
		if ($trabajos_inscripcion["numeros_trabajos"] != "")
			$trabajos_inscripto .= $trabajos_inscripcion["numeros_trabajos"];
		else
			$trabajos_inscripto = substr($trabajos_inscripto,0,-2);
	}
	else
		$trabajos_inscripto = $trabajos_inscripcion["numeros_trabajos"];
	$contador = $contador + $trabajos_inscripcion["cant"];*/
	/*if ($_SESSION["admin"])
		var_dump($trabajos_inscripcion["trabajos"]);*/

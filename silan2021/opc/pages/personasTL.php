...
?>
          <tr>
            <td><input type="checkbox" name="id_autor[]" value="<?=$persona["ID_Personas"]?>" style="display:none">
            <?php if($core->canEdit()){ ?>
            ...
            <td class="td_inscripto"><?=$persona["numero_inscripcion"]?></td>
            <td><?php
				$color = 'red';
            ...
            <td <?php if($persona["lee"]){echo "bgcolor='#eeeeee'";} ?>><?=lee($persona["Apellidos"],$persona["lee"])?></td>

...
class core{
	...
	public function getAreasTL(){
		return $this->db->query("SELECT * FROM areas_trabjos_libres ORDER BY orden")->results();
	}
	...
	public function getPais(){
		return $this->db->query("SELECT * FROM paises ORDER BY Pais")->results();
	}

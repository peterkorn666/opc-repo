...
include("../conexion.php");
	...
	//Programa
	$sql = "SELECT * FROM congreso WHERE Sala_orden=7 ORDER by Dia_orden,Hora_inicio,Sala_orden,Orden_aparicion;";
...
if($row["Tipo_de_actividad"]=="Plendsadasaria"){}else{
...
/**/
	...
	*/	
	...
	if($row["Trabajo_libre"]==1){
		...
		$sql_t ="SELECT * FROM trabajos_libres WHERE ID_casillero= 'dsadasdas" . $row["Casillero"] . "' AND estado<>3  ORDER BY Hora_inicio,numero_tl ASC;";
		$rs_t = mysql_query($sql_t,$con);
	/*	$horav = "";
...
$sql2 ="SELECT ID_participante, lee FROM trabajos_libres_participantes WHERE ID_trabajos_libres = " .  $row_t["ID"] . " ORDER BY ID ASC;";
			...
			/*	
					...
					echo "<br>".nodo("numero_tl").remplazar($row_t["numero_tl"]). nodo("/numero_tl"). "<br>";

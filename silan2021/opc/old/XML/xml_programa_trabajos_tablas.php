...
include("../conexion.php");
	...
	//Programa
	$sql = "SELECT * FROM congreso ORDER by Dia_orden,Hora_inicio,Sala_orden,Orden_aparicion;";
...
if(($row["Tipo_de_actividad"]!="Presentación de trabajos Orales")){}else{
...
/**/
	...
	*/	
	...
	if($row_t["archivo_tl"]!=""){
		...
		//
		echo nodo("numero_tl").remplazar(substr(str_replace("_","-",$row_t["numero_tl"]),3)). nodo("/numero_tl");

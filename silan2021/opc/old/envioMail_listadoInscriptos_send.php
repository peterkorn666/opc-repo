...
copy($_FILES["archivo"]["tmp_name"], "arhivosMails/" . $_FILES["archivo"]["name"]);
}
...
<form action="envioMail_listadoInscriptos_send_frame.php" method="post" enctype="multipart/form-data" name="form1" target="frameEnvio">
</form>
<script>
	form1.submit();
</script>
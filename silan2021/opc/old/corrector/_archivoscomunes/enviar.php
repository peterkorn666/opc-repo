...
if($puede_ingresar){
	if($_SESSION["ID_TL"]!=""){
		...
		$sql = "Insert into trabajos_libres (titulo_tl, area_tl, tipo_tl,  sesion, resumen, archivo_trabajo_comleto, archivo_tl , palabrasClave ,clave,
			 ...
			 paisContacto,
			 ciudadContacto,			 
			 ultima_actualizacion) values ('$tituloTl','$tema', '$tipoTL', '".session_id()."',  '$resumen', '$nombreArchivo', '$nombreArchivo', '$keywords', '$pass',
...
foreach($array_nombre as $i){
	...
	if($array_id[$u]==""){
		$sql = "INSERT INTO personas_trabajos_libres (Nombre , Apellidos , Pais , Institucion , Mail, ciudad, session) VALUES (
					'".$array_nombre[$u]."',
					'".$array_apellido[$u]."',
					'".$array_pais[$u]."',
					'".$array_institucion[$u]."',
...
$cuerpoMail =
'<center>
<h2>'.$congreso.' - Presentación de Trabajo</h2>
		<div  style="width:60%;">
          <div align="left">
		  <font size="4" face="Arial, Helvetica, sans-serif">Trabajo Nº: ' .$numero_de_trabajo. '</font> <br>
		  <font size="3" face="Arial, Helvetica, sans-serif"><em>' .$tema. '</em><br></font>
		  </div>
  </div>
		<div  style="width:60%; padding:5px;">
		  ...
		  Primer Autor: <strong>' . $array_apellido[0] . ", " . $array_nombre[0] . "<em><font color='#990000' > (" . $array_pais[0] . ')</font></em></strong> <br>
		     Inscripto: <strong>' . $autoreInscriptos . '</strong> </font><br>
		  </div>
...
<font size="4"><strong>'. $emailContacto . '</strong></font> </div>
		...
		<div style="width:60%; padding:5px; border:1px #000000 solid">
					<font style="font-family: Times New Roman, Times, serif; font-size: 16px;font-weight: bold;">'.$tituloTl.'</font><br><em>'.$tema.'</em>
					<br>'.$gestionAutores.'<br>
					<br>
				<div align="left">
					<font style="font-family: Times New Roman, Times, serif; font-size: 12px;">
					<b>Resumen:</b> <br>
					'.$resumen.'</font><br> <br />
<em style="font-size:11px;"><strong>Palabras Clave:</strong> '.$keywords.'</em><br><font style="font-family: Times New Roman, Times, serif; font-size: 12px;"><strong>'.$travel_award.'</strong></font>
				</div>
  </div><br><br>
...
foreach($arrayMails as $cualMail){
		...
		if($cualMail == "mattiasgega@gmail.com"){
...
<center>
<div style="padding:4px; width:600; color:#FFFFFF" align="left"><strong>A continuación se muestran los datos que se han guardado de su trabajo.</strong></div>

<div style="border:3px solid #000000; padding:4px; width:600; background-color:#FFFFFF">
  <center>
    <h2>'.$congreso.' - Presentaci&oacute;n de Trabajo</h2>
    <div  style="width:90%;">
    ...
    <div  style="width:90%; padding:5px;">
      <div align="right"> <font size="2" face="Arial, Helvetica, sans-serif"> Presentador: <font size="5"> <strong>
        ...
        Inscripto: <strong> '.$autoreInscriptos.' </strong> </font></div>
		<br>
    ...
    <div style="width:90%; padding:5px; border:1px #000000 solid"> <font style="font-family: Times New Roman, Times, serif; font-size: 16px;font-weight: bold;">
     '.$tituloTl.'
      ...
      <div align="left"> <font style="font-family: Times New Roman, Times, serif; font-size: 12px;"> <b>Resumen:</b> <br>
        ...
        <br />
        <em style="font-size:11px;"><strong>Palabras Clave:</strong>
          '.$keywords.'
        </em><br><font style="font-family: Times New Roman, Times, serif; font-size: 12px;"><strong>'.$travel_award.'</strong></font></div>
    </div>
  </center><br /><br>
<font  style="font-size:14px;">Estos son su<strong> código y contraseña</strong> para <strong>modificar</strong> su trabajo</font>
<div style="width:65%; padding:5px; border:2px #000000 solid;background-color:'.$colorFondoArriba.' ">
...
<br>
<center>
  <div align="center" style="background-color:#FFFFCC; width:650; border:3px solid #000000; font-size:14px;"> <br />

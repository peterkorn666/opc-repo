...
while($row = $rs->fetch_array()){
	?>
<option value="<?=$row["En_calidad"]?>"><?=$row["En_calidad"]?></option>
<? }
}?>
</select></td>
      </tr>
    ...
    <? $cuantosPe = $cuantosPe + 1; ?>
                ...
                <tr bgcolor="#FFFFFF">                  
                  <td width="50"><input name="participante[]" type="checkbox" id="participante[]" value="<?=$row->id_conf?>" class="<?=$row->actividad_idioma_hablado?>">	&nbsp; <?=$idiom?>                 <input name="participante_idioma_<?=$cuantosPe?>" type="hidden" id="participante_idioma_<?=$cuantosPe?>" value="<?=$row->actividad_idioma_hablado?>">
<input name="participante_rol_<?=$cuantosPe?>" type="hidden" id="participante_rol_<?=$cuantosPe?>" value="<?=$calidades?>">

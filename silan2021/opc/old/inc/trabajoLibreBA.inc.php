<link href="../estilosBA.css" rel="stylesheet" type="text/css" />
<?
$separador = "<font size='3' color='#cccccc'> | </font>";
?>
<div id='divTL_Gral_Nuevo' align="left" style="width:550px;">
	  
	  <table style="width:500px" border="0" cellpadding="2" cellspacing="0" bordercolor="#FFFFFF">
          <tr>
            <td align="left" class="bordePunteadoAbajo_Nuevo">
			<table style="width:500px" border="0" cellspacing="0" cellpadding="0" >
				...
				?>
                  ...
                  if($row->area_tl!=""){
                  	echo $separador . "<font color='#003300'>" .remplazar($trabajos->areaID($row->area_tl)->Area). "</font>";
              ...
              if(count($arrayInstitucionesUnicasNuevaClave)>0){
				...
				if ($primero == false ){
              	...
              	//	}
              		...
              		if(count($arrayInstitucionesUnicasNuevaClave)>1 || $row->palabrasClave!=""   || $row->objetivos_resumen!=""|| $row->materialmetodos_resumen!=""|| $row->resultados_resumen!=""|| $row->conclusiones_resumen!=""|| $row->referencias_resumen!=""){
					...
					echo "</font></td><td align='right'>&nbsp;</td></tr></table>";
...
/*
				...
				*/
              	...
              	if($arrayPersonas[0][3] != ""){
              		...
              		$imprimir .= "<font color='#ff3300'>(*)</font> " . $arrayPersonas[0][3];
              			...
              			if($row->palabrasClave!=""  || $row->objetivos_resumen!=""|| $row->materialmetodos_resumen!=""|| $row->resultados_resumen!=""|| $row->conclusiones_resumen!=""|| $row->referencias_resumen!=""){
              			echo  "<table border='0' cellspacing='0' cellpadding='0' width='100%'><tr><td><font color='#ff0000' size='1'><tr><td>&nbsp;
              ...
              if($row->objetivos_resumen!=""|| $row->materialmetodos_resumen!=""|| $row->resultados_resumen!=""|| $row->conclusiones_resumen!=""|| $row->referencias_resumen!=""){
			  
				$imprimir .="<p style='font-family: Arial, Helvetica, sans-serif;font-size: 10px;color: #000000;margin:0px;margin-left:105px;'><br>Resumen:<br>
				<strong>Introducci&oacute;n y Objetivos:</strong><br>
				" . str_replace(chr(13), "<br>", $row->objetivos_resumen);
				if($row->materialmetodos_resumen!=""){
					$imprimir .="<br /><strong>Material y M&eacute;todos:</strong><br />". $row->materialmetodos_resumen;
				}
				if($row->materialmetodos_resumen!=""){
					$imprimir .="<br /><strong>Resultados</strong><br />".$row->resultados_resumen;
				}
				if($row->materialmetodos_resumen!=""){
					$imprimir .="<br /><strong>Conclusiones</strong><br />".$row->conclusiones_resumen;
				}
				if($row->materialmetodos_resumen!=""){
					$imprimir .="<br /><strong>Referencias bibliográficas:</strong><br />".$row->referencias_resumen;
				}
				$imprimir .="</p>";
              	...
              	echo 	'<table width="100%" border="0" cellspacing="0 " cellpadding="0">
						...
						<strong>Introducci&oacute;n y Objetivos</strong><br />
						' .str_replace(chr(13), "<br>", remplazar($row->objetivos_resumen)) .'';
							if($row->materialmetodos_resumen!=""){
								echo "<br /><strong>Material y M&eacute;todos</strong><br />". $row->materialmetodos_resumen;
							}
							if($row->resultados_resumen!=""){
								echo "<br /><strong>Resultados</strong><br />".$row->resultados_resumen;
							}
							if($row->conclusiones_resumen!=""){
								echo "<br /><strong>Conclusiones</strong><br />".$row->conclusiones_resumen;
							}
							if($row->referencias_resumen!=""){
								echo "<br /><strong>Referencias bibliográficas</strong><br />".$row->referencias_resumen;
							}
				...
				if(remplazar($row->objetivos_resumen)!=$row->objetivos_resumen){

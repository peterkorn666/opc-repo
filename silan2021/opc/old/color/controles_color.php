<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	  <div align="center">
	    <?
	$fila_1 = Array("#FFFFFF","#FFEAEA","#FFBFBF","#FF9595","#FF6A6A","#FF4040","#FFEED5","#FFDDAA","#FFCC80","#FFBB55","#FFAA2B","#FFE700");
	$fila_2 = Array("#E9E9E9","#FFFFD5","#FFFFAA","#FFFF80","#FFFF55","#FFFF2B","#E4F1E2","#CAE3C6","#B0D5AA","#96C78D","#7BB971","#8DC641");
	$fila_3 = Array("#CCCCCC","#EAFFFE","#BFFFFC","#95FFFA","#6AFFF8","#00E1D6","#D5E4FF","#AAC8FF","#80ACFF","#5591FF","#2B75FF","#0094DA");
	$fila_4 = Array("#999999","#ECD5FF","#D9AAFF","#C680FF","#B355FF","#9F2BFF","#FFD5F0","#FFAAE1","#FF80D2","#FF55C4","#FF2BB5","#E91D26");

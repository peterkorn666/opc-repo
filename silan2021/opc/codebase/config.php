<?php
	...
	define('MYSQL_BD','silan2020');
	if($_SERVER["SERVER_NAME"] == "localhost" || $_SERVER["SERVER_NAME"] == "crono.loc"){
		define('MYSQL_HOST', 'localhost');
		define('MYSQL_HOST2', 'mysql:host=localhost;dbname='.MYSQL_BD);
		define('MYSQL_USUARIO', 'root');
		define('MYSQL_PASSWORD', '');
	}else{
		define('MYSQL_HOST', 'mysql.gegamultimedios.net');
		define('MYSQL_HOST2', 'mysql:host=mysql.gegamultimedios.net;dbname='.MYSQL_BD);

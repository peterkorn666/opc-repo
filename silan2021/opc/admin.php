...
//		scheduler.config.readonly = true;
		...
		//scheduler.config.limit_start = new Date(2020,11,04);
		...
		scheduler.init('scheduler_here',new Date("2020/11/04"),"single_unit");
	...
	function save_form() {
		...
		$("input[name='persona[]']").each(function(index) {	
			...
			var en_crono = $(".en_crono").eq(index).val();

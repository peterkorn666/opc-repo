        ...
        <div class="col-md-12" style="border: 2px solid black; background-color: #CCCCCC; padding-bottom: 15px;">
            ...
            <div id="div-trabajos-libres" class="col-md-12 tabla_etiquetas">
                ...
                <div class="row fila_separadora">
					...
					<!--Begin etiqueta de certificado de autor
					<div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6 nombre_etiqueta">
                                Link para obtener Certificacion de autor
                            </div>
                            <div class="col-md-6">
                                <span class="etiqueta"><:link_certificaado_autor></span>
                            </div>
                        </div>
                    </div>
					<!--End etiqueta de certificado de autor-->
                </div>
            </div>
            ...
            <!-- Tabla evaluadores -->
            <div id="div-evaluadores" class="col-md-12 tabla_etiquetas">
                <div class="row">
                    <div class="col-md-12 titulo">
                        Evaluadores: (clic para copiar y luego pegar)
                    </div>
                </div>
                <div class="row fila_separadora">
                    <div class="col-md-6 columna_separadora">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var div_etiquetas_evaluadores = $("#div-evaluadores");
        $("select[name='destinatarios']").change(function(){
            ...
            div_etiquetas_evaluadores.hide();
            ...
            switch(destinatario.val()){
                ...
                case '4':
                    ...
                    break;
                case '5':
                    div_etiquetas_evaluadores.show();
                    break;
                default:
                    div_etiquetas_trabajos_libres.show();
                    div_etiquetas_autores.show();

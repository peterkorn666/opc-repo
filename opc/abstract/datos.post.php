...
//var_dump($_SESSION["abstract"]["id_autor"]);
	...
	$_SESSION["abstract"]["modalidad"] = $_POST["modalidad"];
	$_SESSION["abstract"]["tipo_conversatorio"] = $_POST["tipo_conversatorio"];
	...
	$_SESSION["abstract"]["resumen_tl2"] = $_POST["resumen_tl2"]; //htmLawed($_POST["resumen_tl2"],$config);
	$_SESSION["abstract"]["resumen_tl3"] = $_POST["resumen_tl3"]; //htmLawed($_POST["resumen_tl3"],$config);
	$_SESSION["abstract"]["resumen_tl4"] = $_POST["resumen_tl4"]; //htmLawed($_POST["resumen_tl3"],$config);
	$_SESSION["abstract"]["resumen_tl5"] = $_POST["resumen_tl5"]; //htmLawed($_POST["resumen_tl3"],$config);
	...
	$_SESSION["abstract"]["resumen_tl4"] = str_replace("<br>"," ",$_SESSION["abstract"]["resumen_tl4"]);
	$_SESSION["abstract"]["resumen_tl5"] = str_replace("<br>"," ",$_SESSION["abstract"]["resumen_tl5"]);

...
<p><a href="../sistema/modelo.php">Mensaje modelo</a><br />
  <br />
                  ...
                  <td width="80%" valign="top"><table width="95%" height="102" border="0" align="center" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                      <td><!-- InstanceBeginEditable name="titulo" -->Agregar destinatarios desde la base de datos (Seleccionar el envío e indicar los criterios de búsqueda)<!-- InstanceEndEditable --><br /><!-- InstanceBeginEditable name="contenido" -->{Form} {CamposOcultos}<!--BeginFormBuscador-->       
		   <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF" class="textos">
             <tr>
               ...
               <td bgcolor="#E9E9E9" class="textos"><select name="IdEnvio" id="IdEnvio">
                 ...
                 <br />
                 <input name="incluidoEnvio" type="radio" value="cualquiera" id="incluidoEnvio_cualquiera" {checked_incluidoEnvio_cualquiera} />
                 <label for="incluidoEnvio_cualquiera">Cualquier estado</label>
                 <br />
                 <input name="incluidoEnvio" type="radio" value="no" id="incluidoEnvio_no" {checked_incluidoEnvio_no} />
                 <label for="incluidoEnvio_no">No esté en el envío</label>
                 <br />
                 <input name="incluidoEnvio" type="radio" value="si" id="incluidoEnvio_si" {checked_incluidoEnvio_si} />
                 <label for="incluidoEnvio_si">Esté en el envío (cualquier estado)</label>
                 <br />
                 <input name="incluidoEnvio" type="radio" value="pendiente" id="incluidoEnvio_pendiente" {checked_incluidoEnvio_pendiente} />
                 <label for="incluidoEnvio_pendiente">Esté en el envío (pendiente)</label>
                 <br />
                 <input name="incluidoEnvio" type="radio" value="enviado" id="incluidoEnvio_enviado" {checked_incluidoEnvio_enviado} />
                 <label for="incluidoEnvio_enviado">Esté en el envío (enviado)</label>
                 <br />
                 <input name="incluidoEnvio" type="radio" value="rebotado" id="incluidoEnvio_rebotado" {checked_incluidoEnvio_rebotado} />
                 <label for="incluidoEnvio_rebotado">Esté en el envío (rebotado sin envio exitoso)</label>
               </td>
             </tr>
             <tr>
...
<p class="textos" align="right" style="margin:0px;"> <!--BeginPaginarResultado-->
       ...
       <br/>
          ...
          <p>AGREGAR<br /><a href="#" onclick="javascript:js_br.confirmarAccionSeleccionadas('agregar','agregarSusbscriptosSeleccionados');return false;">Agregar los subscriptos seleccionados al envío indicado</a> <br />                       
<a href="#" onclick="javascript: if (confirm('Agrega TODOS los subscriptos del resultado de la búsqueda?')) agregarSusbscriptosTodos();return false">Agregar TODOS los subscriptos de la BUSQUEDA al envío indicado</a><br />
(no agrega si ya está en este envío como pendiente)

<br />          
          <p>QUITAR<br  />
              <a href="#" onclick="javascript:js_br.confirmarAccionSeleccionadas('quitar','quitarSubscriptosSeleccionados');return false;">Quitar los subscriptos seleccionados del envío indicado</a> <br />                       
              <a href="#" onclick="javascript: if (confirm('Quita TODOS los subscriptos del resultado de la búsqueda?')) quitarSusbscriptosTodos(); return false;">Quitar TODOS los subscriptos de la BUSQUEDA del envío indicado</a><br />
            (sólo quita si ya está en este envío como pendiente)
            
  <br />
            
            <script type="text/javascript">
function agregarSusbscriptosSeleccionados(){
	document.frmBuscar.elements["accion"].value="agregarSubscriptosSeleccionados";
	document.frmBuscar.submit();
	return false;
}
function agregarSusbscriptosTodos(){
	document.frmBuscar.elements["accion"].value="agregarSubscriptosTodos";
	document.frmBuscar.submit();
	return false;
}
function quitarSusbscriptosSeleccionados(){
	document.frmBuscar.elements["accion"].value="quitarSubscriptosSeleccionados";
	document.frmBuscar.submit();
	return false;
}
function quitarSusbscriptosTodos(){
	document.frmBuscar.elements["accion"].value="quitarSubscriptosTodos";
	document.frmBuscar.submit();
	return false;
}

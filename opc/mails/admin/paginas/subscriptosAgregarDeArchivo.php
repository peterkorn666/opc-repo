...
<p><a href="../sistema/modelo.php">Mensaje modelo</a><br />
  <br />
                  ...
                  <td width="80%" valign="top"><table width="95%" height="102" border="0" align="center" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                      <td><!-- InstanceBeginEditable name="titulo" -->Agregar subscriptos desde un archivo de texto <!-- InstanceEndEditable --><br /><!-- InstanceBeginEditable name="contenido" -->
                        <p>{Mensaje}</p>{Form}{CamposOcultos}
                          <!--BeginFormBuscador-->
                          <!--EndFormBuscador-->
                          <!--BeginResultado-->
                          <!--EndResultado-->
                        ...
                        <p>Acción a aplicar con estas direcciones: 
                          <select name="operacion" id="operacion">
                            <option value="altaSubscriptos">Alta al sistema y grupos seleccionados</option>
							<option value="bajaGrupos">Baja de grupos seleccionados</option>
                            <option value="bajaSubscriptos">Baja del sistema</option>
                          </select>
						  </p>
                        <p><input type="checkbox" name="limpiarGrupos" id="limpiarGrupos" value="1" /> <label for="limpiarGrupos">Vaciar los grupos seleccionados antes de dar de alta a las nuevas direcciones</label>
						  </p>
          &nbsp;&nbsp; &nbsp;                  
          <input name="submit1" type="submit" id="submit1" value="Agregar subscriptos" />
                          <br />
                          <!--EndFormEdicion-->

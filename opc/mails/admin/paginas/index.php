...
<script type="text/javascript" src="../js/funcionEnter.js"></script><!-- InstanceEndEditable -->
...
<p><a href="../sistema/modelo.php">Mensaje modelo</a><br />
  <br />
                  ...
                  <td width="80%" valign="top"><table width="95%" height="102" border="0" align="center" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                      <td><!-- InstanceBeginEditable name="titulo" -->Sistema de Mails <!-- InstanceEndEditable --><br /><!-- InstanceBeginEditable name="contenido" -->
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="222" bgcolor="#9BD0EF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#9BD0EF">
                                    <tr>
                                      <td> Administre los subscriptos, mensajes y envíos.</td>
                                    </tr>
                                </table></td>

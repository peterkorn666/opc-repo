...
<p><a href="../sistema/modelo.php">Mensaje modelo</a><br />
  <br />
                  ...
                  <td width="80%" valign="top"><table width="95%" height="102" border="0" align="center" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                      <td><!-- InstanceBeginEditable name="titulo" -->Grupos<!-- InstanceEndEditable --><br /><!-- InstanceBeginEditable name="contenido" -->{Form} {CamposOcultos}<!--BeginFormBuscador-->       
             ...
             <tr>
               <td colspan="8" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#E9E9E9" style="border:1px solid #FFFFFF">
                 <tr class="cabezal_asc">
                   <td width="10%" align="center">{Orden_IdGrupo_asc}</td>
                   <td width="40%" align="center">{Orden_Grupo_asc}</td>
                 </tr>
                 <tr class="cabezal">
                   <td width="10%"  align="center"><div align="center" class="Estilo1">Id</div></td>
                   <td width="40%"  align="center"><div align="center" class="Estilo1">Grupo</div></td>
                 </tr>
                 <tr class="cabezal_desc">
                   <td width="10%" align="center">{Orden_IdGrupo_desc}</td>
                   <td width="40%" align="center">{Orden_Grupo_desc}</td>
                 </tr>
			<!--BeginFilaResultado-->
                 <tr  class="resultado_fila{resultado_tipoFila}" {resultado_scriptFila}>
                   <td width="10%">{resultado_IdGrupo}</td>
                   <td width="40%">{resultado_Grupo}</td>
                 </tr>
			<!--EndFilaResultado-->
               </table>
       <br/>

...
<p><a href="../sistema/modelo.php">Mensaje modelo</a><br />
  <br />
                  ...
                  <td width="80%" valign="top"><table width="95%" height="102" border="0" align="center" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                      <td><!-- InstanceBeginEditable name="titulo" -->Agregar destinatarios de un archivo de texto (Seleccionar el envío y archivo)<!-- InstanceEndEditable --><br /><!-- InstanceBeginEditable name="contenido" -->
                        <p>{Mensaje}</p>{Form}{CamposOcultos}
						  ...
						  <p>
						  Envio: <select name="IdEnvio" id="IdEnvio">{envios}</select>
						  </p>
						  <p>

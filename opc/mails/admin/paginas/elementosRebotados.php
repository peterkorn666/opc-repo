...
<p><a href="../sistema/modelo.php">Mensaje modelo</a><br />
  <br />
                  ...
                  <td width="80%" valign="top"><table width="95%" height="102" border="0" align="center" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                      <td><!-- InstanceBeginEditable name="titulo" -->Elementos rebotados sin envío exitoso  (Seleccionar el envío para ver subscriptos)<!-- InstanceEndEditable --><br /><!-- InstanceBeginEditable name="contenido" -->  {Form} {CamposOcultos}<!--BeginFormBuscador-->       
             ...
             <tr>
               ...
               </select><input name="incluidoEnvio" type="hidden" value="rebotado" />
</td>
             </tr>
             <tr>

...
$presentacion->abrir("modelo.php","../paginas/","Principal");

$archivosDatos=DIR_PLANTILLAS . "plantilla.htm";

require "../clases/form_class.php";
$idioma=leerParametro("Idioma","es");
$presentacion->asignarValor("Idioma",$idioma);
$mensajeError="";
$form_abm_1= new form_class();
$form_abm_1->objDatos= new objeto();
$form_abm_1->action="modelo.php";
...
$v=new Variable(1,"","PlantillaHTML",1);	
$v->campoSQL="";
...
function cargarDatos() {
	...
	$form_abm_1->objDatos->asignarValorVariable("PlantillaHTML",str_replace("\n","",str_replace("\r\n","",contenidoArchivo($archivosDatos))));
	$form_abm_1->accion="guardar";
}

function guardarDatos() {
	global $form_abm_1,$archivosDatos;
	escribirEnArchivo($archivosDatos,$form_abm_1->objDatos->darValorVariable("PlantillaHTML"));
}

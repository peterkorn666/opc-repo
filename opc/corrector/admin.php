...
$modalidades = $trabajos_instancia->getModalidesTL();
$areas_tl = $trabajos_instancia->getAreasTL();
$lineas_transversales = $trabajos_instancia->getLineasTransversalesTL();
                        ...
                        <div class="col-md-8">
                            <select name="modalidad" class="form-control">
                                ...
                                foreach($modalidades as $modalidad){
                                    ?>
                                    <option value="<?=$modalidad['id']?>"><?=$modalidad['modalidad_es']?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-md-8">
                            <select name="linea_transversal" class="form-control">
                                ...
                                foreach($lineas_transversales as $linea_transversal){
                                    ?>
                                    <option value="<?=$linea_transversal['id']?>"><?=$linea_transversal['linea_transversal_es']?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <table class="table" id="listado-evaluaciones">
                            <thead>
                                <tr>
                                    ...
                                    <th data-nombre_buscador="Modalidad">Modalidad</th>
                                    <th data-nombre_buscador="Área de trabajo">Área de trabajo</th>
                                    <th data-nombre_buscador="Línea transversal">Línea transversal</th>
                                    <th data-nombre_buscador=""></th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            foreach($evaluaciones as $evaluacion){
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" name="id_trabajos[]" class="checkbox_trabajos" value="<?=$evaluacion['id_trabajo']?>"></td>

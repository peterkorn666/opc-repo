...
$_SESSION["inscriptos"] = $_POST["inscriptos"];
/*foreach($_POST as $index => $dato){
	echo $index."<br>";
	var_dump($dato);
	echo "<br>";
}
...
$_SESSION["total_de_envio"] = count($_POST["inscriptos"]);
...
<form action="envioMail_inscriptos_send_frame.php" method="post" enctype="multipart/form-data" name="form1" target="frameEnvio">
</form>
<script>
	form1.submit();
</script>
...
/*	var areaTLSeleccionada = false;
	...
	if(archivoAdjuntadoR == 0){
		alert("Por favor, debe adjuntar algún archivo de resumen.")
...
function adjuntarArchivo(){
	...
	if(document.form1.archivo.value==""){
		alert("Por favor, seleccione un archivo *.doc o *.rtf para ser adjuntado");
		document.form1.archivo.focus();
		return; 
	}
	...
	if(extension=="doc" || extension=="rtf" ){
		...
		alert("El archivo seleccionado debe ser *.doc o *.rtf");
		document.form1.archivo.focus();
		return; 
	}

...
<?
$url = "altaTematicaEnviarNuevo.php";
$titulo = "Alta";

if($_GET["id"] != "")
{
	$url = "gestionTematica.php?modificar=true&id=" .$_GET["id"];
	$titulo = "Modificar";
  	  $sql = "SELECT * FROM tematicas WHERE ID_Tematicas = " . $_GET["id"];
...
<table width="770" height="100%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#999999" bgcolor="#F0E6F0">
  ...
  <tr style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif">
    <td valign="top"><div align="center"><br>
        ...
        Tem&aacute;ticas</font></strong><br>
        <br>
        <table width="100%" border="1" cellpadding="5" cellspacing="2" bordercolor="#ECF4F9" bgcolor="#ECF4F9">
    <tr valign="top">
	  ...
	  <table width="380" height="100"  border="0" cellpadding="4" cellspacing="0" bgcolor="#ECF4F9">
        <tr valign="top">
          <td height="10"  class="crono_trab">Antes de agregar una tem&aacute;tica compruebe que no exista en la lista </td>
        </tr>
        <tr valign="top">
          <td height="10" >
        ...
        <tr valign="top">
          <td height="10" ><div align="right"><font size="2">
	...
	$rs = mysql_query($sql,$con);
	while ($row = mysql_fetch_array($rs)){
	echo  "<a href='altaTematica.php?id=" . $row["ID_Tematicas"]  . "'><img src='img/modificar.png' border='0' alt='Modificar esta temática'></a>";
	echo  "<a href='javascript:eliminar(" .  $row["ID_Tematicas"] . ")'><img src='img/eliminar.png' border='0'  alt='Eliminar esta temática'></a> ";
...
$sql = "SELECT * FROM tematicas ORDER by Tematica ASC";
	...
	echo "<script>arrayTematicaNuevo.push('" . $row["Tematica"] ."')</script>\n";
	}
}
?>

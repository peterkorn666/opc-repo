	...
	<div class="col-xs-10 col-md-offset-2">
        <table width="95%" style="width:93%;margin-bottom:0px;" class="table table-striped table_tl">
          <tr>
            ...
            <td align="right">
            	<?php
					if($row->archivo_tl_poster!=""){
				?>
            	<a href="posters/<?=$row->archivo_tl_poster?>" target="_blank" style="display: block;margin-top: -25px;position: relative;"><img src="imagenes/pdf.png" alt="pdf" /></a>
                <?php
					}
				?>
             </td>

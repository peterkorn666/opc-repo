...
?>
<div id='divTL_Gral' align="center" style="border:1px solid black">
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" bordercolor="#FFFFFF">
          <tr>
            <td align="left" class="bordePunteadoAbajo">
				...
				?>
				  ...
				  $imprimir .= "<p style=\"font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;font-size: 10px;color: #333300;margin:0 0 5px 105px\"><b>" . $row->numero_tl. "</b>\n";
				  ?>
				 ...
				 // echo "$separador <span id='words$row->ID'></span>";
                  ...
                  if($row->area_tl!=""){
                  	...
                  	$imprimir .= "<font color='#cccccc'> | </font><span style=\"font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;font-size: 11px;\">" .remplazar($trabajos->areaID($row->area_tl)->Area)."</span>";
                  }
          ...
          <tr>
            ...
            if($hayBeta){
				...
				$titulo = "<span style=\"font-size:15px;font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif\">".remplazar($row->titulo_tl)."</span><br>";
				echo $titulo;		
			}
			//$imprimir .= '<span style="font-size:10px">'.$row->tipo_tl." / ".$trabajos->areaID($row->area_tl)->id." - ".$trabajos->areaID($row->area_tl)->Area."</span>";
			?></td>
            <?
			  $imprimir .= "<p style='font-family: Arial, Helvetica, sans-serif;font-size: 12px;color: #003366;margin:0px 0px 5px 105px'><b>" . $titulo . "</b></p>\n";
          ...
          <tr>
            <td height="20" class="autoresTL"><? 
              ...
              $imprimir .= "<p style=\"font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;font-size: 13px;color: #000000;margin:0px;margin-left:105px;\">";
            ...
            <td height="20" ><?
              ...
              if(count($arrayInstitucionesUnicasNuevaClave)>0){
              	...
              	///	if($clave==1){
              			...
              			$imprimir .= "<p style=\"font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;font-size: 11px;color: #000000;margin:0px;margin-left:105px;\"><i> <font color='#ff0000'>$clave</font> - $ins</i>";
...
<td  align='right'>$masInfo</td></tr></table>";
             ...
             // if($row->resumen!=""){
				$imprimir .="
					<p style=\"font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;font-size: 13px;color: #000000;margin:0px;margin-left:105px; text-align:justify\"><br>
				...
				$imprimir .= "<br>Contacto: $row->contacto_mail</span><br>@@@";

...
<table width="770" align="center" cellpadding="2" cellspacing="5" bgcolor="#CCCCCC">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="2">
    <tr valign="top">
	 ...
	 <? }?>
	<form name="form1" method="post" action="altaActividadEnviarNuevo.php"><table width="100%" height="100%" style=" border:1px; border-style:solid; border-color:#333; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:11px" cellpadding="4" cellspacing="0" bgcolor="#ECF4F9" >
        <tr valign="top">

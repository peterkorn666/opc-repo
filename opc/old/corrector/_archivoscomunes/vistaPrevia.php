...
$_SESSION["tema"] = $_POST["tema"];
if($_SESSION["tema"]=="Otro"){
	$_SESSION["tema"] = "Otro:".$_POST["OtroTema"]; 
}
...
?>
	<center>
	<table width="604" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
	  <tr bgcolor="#F0F0F0">
		<td width="600" bordercolor="#000000"><table width="100%" border="0" cellpadding="5" cellspacing="0">
          <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
                  <tr>
                    <td height="116">
                      <div align="left">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="Submit32" type="button" class="botones" onClick="volverIndex()" value="&lt; Atras" style="width:100px;" />
                        &nbsp;&nbsp;</div></td></tr>
                    <tr>
                    <td>
					<?
                    ...
                    <? if($subirArch==true){ ?>
					  <td>
                      <table width="95%" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#000000" bgcolor="#FFFFCC">
  <tr>
    <td> <span  class="textos">
	<? if($_SESSION["archivo_trabajo_comleto"]!=""){ 
	$nombreArchivo = $_SESSION["archivo_trabajo_comleto"];
	?>
		Archivo actual  (<em>solo lectura</em>): <a href='../programa/bajando_tl.php?id=<?=$nombreArchivo?>'> <img src='../programa/img/filesave.png' border='0' align='absmiddle' > <?=$nombreArchivo?></a><br>
		<?	}
	?>

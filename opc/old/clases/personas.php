...
class personas{	
	...
	function trabajosPersona($cualID){
		$sql = "SELECT t.id_trabajo, t.numero_tl, t.titulo_tl FROM trabajos_libres t JOIN trabajos_libres_participantes tp ON t.id_trabajo=tp.ID_trabajos_libres WHERE tp.ID_participante= $cualID";
		$rs = $this->nCon->query($sql);

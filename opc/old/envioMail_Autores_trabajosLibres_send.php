...
$_SESSION["autor"] = $_POST["autor"];  //ARRAY benditosssssssssssssssssssssssssss............

$_SESSION["numero_de_envio"] = 0;

$_SESSION["total_de_envio"] = count($_POST["autor"]);
...
<form action="envioMail_Autores_trabajosLibres_send_frame.php" method="post" enctype="multipart/form-data" name="form1" target="frameEnvio">
</form>
<script>
	form1.submit();
</script>
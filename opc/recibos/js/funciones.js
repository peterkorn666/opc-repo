...
function validar_form(){	
	var check = false;
	var ignore = Array('grupo_check_comprobante', 'grupo_numero_comprobante', 'key_cuenta', 'input_selected_autor[]', 'credit_card_type', 'credit_card_number', 'credit_card_expire', 'credit_card_cvc');

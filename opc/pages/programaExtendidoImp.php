...
require("../class/templates.opc.imp.php");
$core = new Core();
$config = $core->getConfig();
$templates = new templateOPC1();
...
<head>
    ...
    <script type="text/javascript" src="<?php echo $config['url_opc'] ?>/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="<?php echo $config['url_opc'] ?>/js/programaTL.js"></script>
</head>
<body>
<div align="center">

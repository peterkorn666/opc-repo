...
$altoAbsoluto = $bannerheight[1]-250;
...
$getTotalSalas = $core->query("SELECT section_id,start_date FROM cronograma WHERE SUBSTRING(start_date,1,10)='$toDay' GROUP BY section_id ORDER BY section_id DESC");
...
$sqlCrono = $core->query("SELECT c.start_date,c.end_date,c.section_id, s.salaid, s.orden FROM cronograma as c JOIN salas as s ON c.section_id=s.salaid WHERE SUBSTRING(start_date,1,10)='$toDay' GROUP BY section_id ORDER BY s.orden, c.start_date ASC");
